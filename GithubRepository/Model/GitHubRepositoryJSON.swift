...
struct GitHubRepoaitoryJSONElement: Codable {
    ...
    let owner: Owner?
    let htmlURL: String?
    let gitHubRepoaitoryJSONDescription: String?
    let fork: Bool?
    ...
    enum CodingKeys: String, CodingKey {
        ...
        case gitHubRepoaitoryJSONPrivate = "private"
        case owner
        case htmlURL = "html_url"
        case gitHubRepoaitoryJSONDescription = "description"
        case fork, url
